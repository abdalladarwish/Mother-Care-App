...
class TimelineResourceScreen extends StatelessWidget {
  static final route = 'timeline-resource';
  final String styles = '''<style>
    ...
    @media (pointer: coarse) {
        ...
        .ql-snow.ql-toolbar button:not(.ql-active) .ql-fill,
        .ql-snow .ql-toolbar button:not(.ql-active) .ql-fill,
        .ql-snow.ql-toolbar button:not(.ql-active) .ql-stroke.ql-fill,
        .ql-snow .ql-toolbar button:not(.ql-active) .ql-stroke.ql-fill {
            fill: #444;
        }

        .ql-snow.ql-toolbar button:not(.ql-active) .ql-stroke,
        .ql-snow .ql-toolbar button:not(.ql-active) .ql-stroke,
        .ql-snow.ql-toolbar button:not(.ql-active) .ql-stroke-miter,
        .ql-snow .ql-toolbar button:not(.ql-active) .ql-stroke-miter {
            stroke: #444;
        }
    }
  ...
  const TimelineResourceScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final Blog blogDate = ModalRoute.of(context)!.settings.arguments as Blog;
    return SafeArea(
      child: Scaffold(
        body: Column(
          ...
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  _buildImageFromBase64(blogDate.coverImage!.picBytes!),
                  Container(
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            NavigatorKeys.tabNavigatorKeys[TabType.TIMELINE]!.currentState?.pop();
                          },
                        ...
                        Container(
                          ...
                          child: Icon(
                            blogDate.isLiked ? Icons.favorite_outlined: Icons.favorite_border_outlined,
                            color: Colors.red,
                          ),
                        )
                      ],
            ...
            Padding(
              ...
              child: HtmlWidget(HtmlData(blogDate.htmlText!, styles: styles)),
            )
          ],
        ),
      ),
