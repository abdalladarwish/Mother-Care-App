...
import 'package:flutter_html/src/widgets/iframe_unsupported.dart'
  ...
  if (dart.library.htmlData) 'package:flutter_html/src/widgets/iframe_web.dart';
...
ReplacedElement parseReplacedElement(
  ...
  switch (element.localName) {
    ...
    case "iframe":
      element.attributes['width'] = "100%";                              // Custom Change
      element.attributes['height'] = "100%";                             // Custom Change
      return IframeContentElement(
          name: "iframe",
          src: element.outerHtml,                                        // Custom Change
          width: double.tryParse("0"),
          height: double.tryParse("0"),
          navigationDelegate: navigationDelegateForIframe,
          node: element,
      );
    case "img":
